...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/matplotx-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14729&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/matplotx-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `matplotx` can be installed with:

```
conda install matplotx
```

It is possible to list all of the versions of `matplotx` available on your platform with:
